...
Alpha: 08MAR22
Kludge: 24MAR22, doesnt need IP address
'''
...
print('This is a serial server forwarding from multicast ports.')
...
if enable_heading_hdt:
    ...
    s3.setsockopt(socket.IPPROTO_IP, socket.IP_ADD_MEMBERSHIP, mreq)
